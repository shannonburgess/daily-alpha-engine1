...
def _decode_monitor_event(item: Any) -> dict[str, Any] | None:
    ...
    return {
        ...
        "entry_type": ingress.get("entry_type"),
        "runner_stage": ingress.get("runner_stage"),
        "position_fraction": ingress.get("position_fraction"),
        "earnings_gap_class": ingress.get("earnings_gap_class"),
        "stock_stop_price": ingress.get("stock_stop_price"),
        "average_daily_dollar_volume": ingress.get("average_daily_dollar_volume"),
        "breakout_level": ingress.get("breakout_level"),
        "armed_age": ingress.get("armed_age"),
        "exit_reason": ingress.get("exit_reason"),
