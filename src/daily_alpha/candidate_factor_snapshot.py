...
def build_candidate_factor_snapshot(
    *,
    ...
    """Map only observed candidate evidence into a factor vector.
    ...
    weighted_coverage = _weighted_coverage(availability, active_weights)
...
def write_candidate_factor_snapshots(
    ...
    """Write an auditable research artifact without changing candidate ranking."""
