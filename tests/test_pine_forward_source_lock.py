...
from daily_alpha.pine_parity_proof_gate import evaluate_v24_parity_proof_gate
...
def _history() -> LockedHistoricalV24Evaluation:
    return LockedHistoricalV24Evaluation(
        reference_id="locked-history",
...
def test_caller_supplied_wrong_source_provenance_cannot_complete_sh24_forward_proof() -> None:
    gate = evaluate_v24_parity_proof_gate(
        historical_evaluation=_history(),
        forward_evaluation=_forward("f" * 40),
